...
L.TileLayer.ArcGISDynamicLayer = L.TileLayer.extend({
    ...
    initialize: function (url, options) {
        ...
        var params = L.extend({}, this.defaultWmsParams);
        ...
        //override tile size that was 256
        options.tileSize = 512;

        params.width = params.height = options.tileSize * (options.detectRetina && L.Browser.retina ? 2 : 1);
    ...
    onAdd: function (map) {
        ...
        //this.params[projectionKey] = this._crs.code;
    ...
    getTileUrl: function (tilePoint) {
        ...
        url = url + "/export" + L.Util.getParamString(this.params, url, this.options.uppercase) +
			(this.options.uppercase ? '&BBOX=' : '&bbox=') + bbox + "&layers=show:";
        url = url.replace("layers", "_layers") + this.options.arcgislayerid;
        return url;
...
*/
L.tileLayer.arcGISDynamicLayer = function (url, options) {
    return new L.TileLayer.ArcGISDynamicLayer(url, options);
};
